...
\directlua{
scores = {
  full_score = "Full Score\string\\newline(Kyrie and first movement of Gloria)"
}
...
\lastname{Haydn}
\namesuffix{(uncertain attribution)}
\shortname{M. Haydn}
...
\textit{Note by the editor:} The project has been canceled, since the initial movements indicated that the piece is of secondary quality, and Haydn is most likely not the author.
